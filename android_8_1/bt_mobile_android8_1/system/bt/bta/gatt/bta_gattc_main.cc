...
const tBTA_GATTC_ACTION bta_gattc_action[] = {bta_gattc_open,				// actions called from bta_gattc_sm_execute: 0
                                              bta_gattc_open_fail,			// 1
                                              bta_gattc_open_error,			// 2
                                              bta_gattc_cancel_open,		// 3
                                              bta_gattc_cancel_open_ok,		// 4
                                              bta_gattc_cancel_open_error,	// 5
                                              bta_gattc_conn,				// 6
                                              bta_gattc_start_discover,		// 7
                                              bta_gattc_disc_cmpl,			// 8

                                              bta_gattc_q_cmd,				// 9
                                              bta_gattc_close,				// 10
                                              bta_gattc_close_fail,			// 11
                                              bta_gattc_read,				// 12
                                              bta_gattc_write,				// 13

                                              bta_gattc_op_cmpl,			// 14
                                              bta_gattc_search,				// 15
                                              bta_gattc_fail,				// 16
                                              bta_gattc_confirm,			// 17
                                              bta_gattc_execute,			// 18
                                              bta_gattc_read_multi,			// 19
                                              bta_gattc_ignore_op_cmpl,		// 20
                                              bta_gattc_disc_close,			// 21
                                              bta_gattc_restart_discover,	// 22
                                              bta_gattc_cfg_mtu};			// 23
 ...
 *
 *Actions list:
 *										 	   bta_gattc_open,				// actions called from bta_gattc_sm_execute: 0
 *										       bta_gattc_open_fail,				// 1
 *                                             bta_gattc_open_error,			// 2
 *                                             bta_gattc_cancel_open,			// 3
 *                                             bta_gattc_cancel_open_ok,		// 4
...
//#endif
  ...
  for (i = 0; i < BTA_GATTC_ACTIONS; i++) {
    ...
    if (action != BTA_GATTC_IGNORE) {
    	APPL_TRACE_DEBUG("%s action = %d = 0x%02x", __func__, action, action);
