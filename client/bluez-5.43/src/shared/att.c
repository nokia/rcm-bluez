...
// BEGIN ++++++++++++++++++++++++++++++++++++++++++++++++++++++
struct bt_att *bt_remote_att_new(bool ext_signed)
{
	...
	{
		printf("[bt_remote_att_new] att->mtu < BT_ATT_DEFAULT_LE_MTU\n");
		goto fail;
	}
...
// BEGIN ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
unsigned int bt_remote_att_register_disconnect(struct bt_att *att,
					bt_att_disconnect_func_t callback,
					void *user_data,
					bt_att_destroy_func_t destroy)
{
...
// BEGIN ++++++++++++++++++++++++++++++++++++++++++++++++++++++++
unsigned int bt_remote_att_register(struct bt_att *att, uint8_t opcode,
						bt_att_notify_func_t callback,
						void *user_data,
						bt_att_destroy_func_t destroy)
{
