...
typedef void (*discovering_cb_t)(void *userdata);
typedef void (*stop_discovery_cb_t)(void *userdata);
...
typedef void (*device_found_cb_t)(uint16_t index,
 	   	   	 	 	 	 	 	  uint16_t length,
								  const void *param,
								  void *user_data);

typedef void (*connect_ev_cb_t)(uint16_t index,
 	   	   	 	 	 	 	 	  uint16_t length,
								  const void *param,
								  void *user_data);
